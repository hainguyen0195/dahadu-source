                                ...
                                <td class="align-middle">
                                    <?php
                                        if(isset($items[$i]['tinhtrang']) && $items[$i]['tinhtrang'] > 0)
                                        {
                                            ...
                                            $tinhtrang = $d->rawQueryOne("select trangthaivi from #_status where id = ?",array($id_tinhtrang));
                                        }
                                    ?>
                                    <span class="<?=$arrStatus[$id_tinhtrang-1]?> text-capitalize"><?=$tinhtrang['trangthaivi']?></span>
                                </td>
                                <?php if(
                                    (isset($config['order']['excel']) && $config['order']['excel'] == true) || 
                                    (isset($config['order']['word']) && $config['order']['word'] == true)
