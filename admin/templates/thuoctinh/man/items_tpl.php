<?php 
	$linkMan = "index.php?com=thuoctinh&act=man&type=".$type."&p=".$curPage;
	$linkAdd = "index.php?com=thuoctinh&act=add&type=".$type."&p=".$curPage;
    $linkEdit = "index.php?com=thuoctinh&act=edit&type=".$type."&p=".$curPage;
    $linkDelete = "index.php?com=thuoctinh&act=delete&type=".$type."&p=".$curPage;
?>
<!-- Content Header -->
                    ...
                    <tbody>
                        <?php for($i=0;$i<count($items);$i++) { ?>
                            <tr>
                                ...
                                <td class="align-middle">
                                    <input type="number" class="form-control form-control-mini m-auto update-stt" min="0" value="<?=$items[$i]['stt']?>" data-id="<?=$items[$i]['id']?>" data-table="thuoctinh">
                                </td>
                                <td class="align-middle">
								...
								<td class="align-middle text-center">
                                	<div class="custom-control custom-checkbox my-checkbox">
                                        <input type="checkbox" class="custom-control-input show-checkbox" id="show-checkbox-<?=$items[$i]['id']?>" data-table="thuoctinh" data-id="<?=$items[$i]['id']?>" data-loai="hienthi" <?=($items[$i]['hienthi'])?'checked':''?>>
