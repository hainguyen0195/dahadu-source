...
<section class="content">
	<form class="validation-form" novalidate method="post" action="<?= $linkSave ?>" enctype="multipart/form-data">
					...
					<div class="card card-primary card-outline text-sm">
						...
						<div class="card-body">
							<div class="form-group-category row">
								...
								<?php } ?>
								<?php if (isset($config['product'][$type]['giatheomausize']) && $config['product'][$type]['giatheomausize'] == false) { ?>
		...
		<?php
		if (isset($config['product'][$type]['giatheomausize']) && $config['product'][$type]['giatheomausize'] == true) {
			include TEMPLATE . LAYOUT . "sizecolorprice.php";
		}
		?>
